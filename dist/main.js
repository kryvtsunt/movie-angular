...
var MovieComponent = /** @class */ (function () {
    ...
    MovieComponent.prototype.countLikes = function () {
        var _this = this;
        this.movieService.findMovie(this.movie.id).then(function (movie) {
            if (movie === null) {
                _this.numberOfLikes = 0;
            }
            else {
                _this.numberOfLikes = movie.likes;
            }
        });
    };
...
var OmdbTestComponent = /** @class */ (function () {
    ...
    OmdbTestComponent.prototype.searchMovie = function (title) {
        var _this = this;
        this.omdbService.searchMovieByTitle(title).subscribe(function (result) {
            console.log(result);
            _this.result = result;
        });
        this.omdbService.searchMovieByTitle2(title).subscribe(function (result) {
            console.log(result);
...
var OmdbServiceClient = /** @class */ (function () {
    ...
    OmdbServiceClient.prototype.searchMovieByTitle2 = function (title) {
        var url2 = 'https://api.themoviedb.org/3/home/movie?api_key=01202464e80fb52cd90af159ba329661&query=' + title;
